...
declare module NotifyJS {
    interface Options {
         ...
         *
         * For more information on styles, refer to NotifyJSStyleDefinition.
         */
        style?: string;
         ...
         *
         * NotifyJS looks through the classes defined in the given style and will apply the CSS
    ...
    interface JQueryStatic {
        ...
        /**
         * Define a style for NotifyJS to use.
         */
...
interface JQuery {
    ...
    notify(text: string, options?: NotifyJS.Options): void;
    notify(data: any, className?: string): void;
    notify(data: any, options?: NotifyJS.Options): void;
}
